        ...
        <article class="entrada-blog">
            ...
            <div class="texto-entrada">
                <a href="entrada.php">
                    ...
                    <p>Escrito el: <span>19/11/2023</span> por: <span>Admin</span></p>
        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    ...
                    <source srcset="build/img/blog3.jpg" type="image/jpge">
        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    ...
                    <source srcset="build/img/blog4.jpg" type="image/jpge">
